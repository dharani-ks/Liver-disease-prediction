...
# Prediction route
# Load the trained imputer and scaler
...
def predict():
    try:
        ...
        # Apply the **pre-trained** imputer and scaler
        ...
        prediction = int(prediction)  # Convert to integer
        ...
        if prediction == 0:
            return render_template('result.html', 
                           ...
                           causes=["Healthy lifestyle, balanced diet, and regular physical activity."],
                           accuracy=accuracy)
        else:
