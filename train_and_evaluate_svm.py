...
from sklearn.svm import SVC  # Changed to Support Vector Machine (SVC)
...
# Step 10: Train the model (Support Vector Machine)
model = SVC(kernel='linear', random_state=42)  # Use SVM with a linear kernel
...
model_status = [["Model", "SVC (Support Vector Machine)"],
